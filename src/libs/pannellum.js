...
export default (function(window, document, undefined) {
  function Viewer(container, initialConfig) {
    ...
    defaultConfig.uiText = {
      ...
      textureSizeError:
        "This panorama is too big for your device! It's %spx wide, but your device only supports images up to %spx wide. Try another device. (If you're the author, try scaling down the image.)", // Two substitutions: image width, max image width
    ...
    function deviceOrientationTest(e) {
      ...
      if (e && e.alpha !== null && e.beta !== null && e.gamma !== null) {
        ...
        if (startOrientationIfSupported) startOrientation();
      } else {
    ...
    function onDocumentKeyPress(event) {
      ...
      if (usedKeyNumbers.indexOf(keynumber) < 0) return;
      event.preventDefault();
          ...
          switch (key) {
            ...
            case "orientationOnByDefault":
              if (config[key]) {
                ...
                else if (orientationSupport === true) startOrientation();
              }
              break;
          }
        }
